...
The goal of this project is to make a model that accurately predicts the used car prices. For this goal as much useful information needs to be pulled and adapted to the model constraints.
...
To make the data frame useful for the model changes were made to data and columns to make more useful to the model:
- `Year`: Changed to age
- `Owner`: Changed to number of owners
- `Transmision`: Changed to a Boolean of if the car was manual or not.
- `Fuel Type`,`Drivetrain`,`Seller Type`,`Color`,`Make`,`Location`: All OneHotEncoded for the model to understand
